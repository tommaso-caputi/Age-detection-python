...
while cap.isOpened():
    ...
    for faceBox in faceBoxes:
        ...
        genderNet.setInput(blob)
        genderPreds=genderNet.forward()
        gender = "Maschio" if genderPreds[0].argmax(0)==0 else "Femmina"

        cv2.putText(resultImg, gender+" "+age, (faceBox[0], faceBox[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,255), 1)
        cv2.imshow("Face and age detection", resultImg)
